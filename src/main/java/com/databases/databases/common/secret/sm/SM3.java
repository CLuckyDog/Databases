package com.databases.databases.common.secret.sm;
...
//		System.out.println("");
	...
	{
		return back(SubUtil.intToBytes(num));
	}

	private static int bigEndianByteToInt(byte[] bytes)
	{
		return SubUtil.byteToInt(back(bytes));
	}
	...
	public static byte[] padding(byte[] in, int bLen) {
		...
		pos += padd.length;
		byte[] tmp = back(SubUtil.longToBytes(n));
